...
public class MainLivroAutor {
    ...
    public void incluirAutor() throws Exception {
        ...
        System.out.println("Deseja incluir um livro para esse autor?");
    ...
    public void listarAutoresdeUmlivro() throws Exception {
        ...
        List<Autor> listaAutordeUmLivro = livroDAO.listarAutoresDeUmLivro(idLivro);
        for (Autor autor : listaAutordeUmLivro) {
            System.out.print(autor.getNome() + ";");
        }
        System.out.print("\n");
    ...
    private void listarLivrosDeUmAutor() throws Exception {
        System.out.print("Digite o ID do AUTOR:");
        Scanner sc = new Scanner(System.in, "ISO-8859-1");
        int idAutor = sc.nextInt();
        List<Livro> listaLivroDeUmAutor = autorDAO.listarLivrosDoAutor(idAutor);
        for (Livro livro : listaLivroDeUmAutor) {
