...
public class LivroDAO {
    ...
    private final String stmtInserir = "INSERT INTO lpoo.livro(titulo) VALUES(?)";
    private final String stmtConsultar = "SELECT * FROM lpoo.livro WHERE id = ?";
    private final String stmtListaLivroAutor = "SELECT * FROM lpoo.livro";
    ...
    private void gravarAutores(Livro livro, Connection con) throws SQLException {
        String sql = "INSERT INTO lpoo.livro_autor (idLivro, idAutor) VALUES ( ?, ?)";
    ...
    public List<Autor> listarAutoresDeUmLivro(int idLivro) {
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
            ...
            stmt = con.prepareStatement(stmtListaLivroAutor);
            rs = stmt.executeQuery();
            List<Autor> listaAutores = lerAutores(idLivro, con);
            return listaAutores;
